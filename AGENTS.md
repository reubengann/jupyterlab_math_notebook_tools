...
Use the `work` conda environment for all Python commands (notebooks helpers, scripts, one-off checks).
...
& "$env:USERPROFILE\anaconda3\Scripts\conda.exe" run -n work python some_script.py
```
